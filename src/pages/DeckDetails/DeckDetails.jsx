...
// import { getOneDeckByUserId } from '../../utilities/decks';
// import { checkToken } from '../../utilities/user-api';

export default function DeckDetails() {
    const location = useLocation();
    const { user, deck } = location.state || {};
    // const [populatedDeck, setPopulatedDeck] = useState(null);
    ...
    //       try {
    //         console.log('its calling for the first time')
    //         const deckData = await getOneDeckByUserId(deck._id);
    //         console.log('check 2.0000')
    //         console.log(deckData)
    //         setPopulatedDeck(deckData);
    //       } catch (error) {
    //         console.error(error);
    //       }
    //   }
